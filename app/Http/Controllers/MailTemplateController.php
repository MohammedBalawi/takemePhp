...
class MailTemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = app(MailTemplateService::class)->getTemplate((string) $type);
        $pageTitle = __('message.mail_template',['name' => __('message.'.$type)]);
    ...
    public function store(Request $request)
    {
        ...
        $bodyHtml = (string) $request->description;
        $bodyText = (string) $request->body_text;
        app(MailTemplateService::class)->saveTemplate((string) $type, $subject, $bodyHtml, $bodyText);
