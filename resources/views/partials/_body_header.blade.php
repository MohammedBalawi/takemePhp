        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            ...
            <div class="d-flex align-items-center">
                @php
                    ...
                    $admin_language = session('admin_language', 'ar');
                @endphp
                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">                        
                                ...
                                <div class="card shadow-none m-0 border-0">
                                    <div class="p-0 ">
                                        <ul class="dropdown-menu-1 list-group list-group-flush">
                                            @php
                                                $lang = $app_settings->language_option ?? 'ar';
                                                $language_array = !empty($lang) ? languagesArray($lang) : [];
                                            @endphp
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                <img src="{{ asset('images/default.png') }}" class="img-fluid avatar-rounded" alt="user">
                                <span class="ml-2 d-none d-lg-inline">{{ $admin_name }}</span>
                                <span class="ml-2 badge badge-light">{{ $admin_language }}</span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                <li class="dropdown-item d-flex">
                                    <span class="text-muted">Admin:</span>
                                    <span class="ml-2">{{ $admin_name }}</span>
                                </li>
                                <li class="dropdown-item d-flex">
                                    <span class="text-muted">Language:</span>
                                    <span class="ml-2">{{ $admin_language }}</span>
                                </li>
                                <li class="dropdown-item d-flex ">
