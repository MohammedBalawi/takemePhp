                                    ...
                                    <div class="card-body why-choose-card-body" id="card{{ $key }}">
                                        <div class="d-flex justify-content-center">
                                            <div class="why-round-image">
                                                <img src="{{ getSingleMediaSettingImage('frontend_data_image', $why_choose_data->id != null ? $why_choose_data : null ,'whychoose_image') }}" height="60" width="60">
                                            </div>
                                        </div>
                        ...
                        <div class="testimonial p-4 d-flex align-items-center">
                            ...
                            <div class="col-lg-6 d-flex justify-content-end position-relative">
                                ...
                                <div class="profile-image-wrapper testimonial-image-div">
                                    <img src="{{ getSingleMediaSettingImage('frontend_data_image', $item->id != null ? $item : null,'testimonial_image') }}" class="profile-image testimonial-image-div">
                                </div>
                            </div>
                        </div>
                    </div>
