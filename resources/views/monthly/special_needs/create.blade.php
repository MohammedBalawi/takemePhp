            ...
            <div class="col-lg-12">
                <div class="card border-radius-20">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('monthly.special_needs.index') }}" class="float-right btn btn-sm border-radius-10 btn-primary me-2">
                            <i class="fas fa-arrow-circle-left"></i> {{ __('message.back') }}
                        </a>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('monthly.special_needs.store') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label class="form-control-label">البريد</label>
