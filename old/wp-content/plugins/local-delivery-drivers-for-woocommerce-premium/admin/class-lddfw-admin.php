					...
					if ( intval( $order_driverid ) === intval( $driver_id ) && ( $current_order_status === $out_for_delivery_status || $current_order_status === $failed_attempt_status ) ) {
						...
						if ( lddfw_fs()->is__premium_only() ) {
							if ( lddfw_fs()->is_plan( 'premium', true ) ) {
								...
								$status_note = sprintf( esc_html__( 'Driver %s changed order status', 'lddfw' ), esc_html( $user->display_name ) );
							}
						}
	...
	public function lddfw_settings_init() {
		...
		if ( lddfw_fs()->is__premium_only() ) {
			if ( lddfw_fs()->is_plan( 'premium', true ) ) {
				...
				register_setting( 'lddfw-drivers-settings', 'lddfw_driver_photo_permission' );
				register_setting( 'lddfw-drivers-settings', 'lddfw_driver_name_permission' );
				register_setting( 'lddfw-drivers-settings', 'lddfw_driver_phone_permission' );
...
<div class='lddfw_toggle_area' style='display:none'>
	<p style='margin-top:10px;margin-bottom:5px;'><?php echo esc_html( __( 'SMS template', 'lddfw' ) ); ?>
		<?php echo '<a href="#" class="lddfw_copy_template_to_textarea" data="Hello [billing_first_name], the delivery for order #[order_id] with [store_name] has been started. [estimated_time_of_arrival]"><b>' . esc_html( __( 'Default template', 'lddfw' ) ) . '</b></a>'; ?>
</p>
	...
	public function lddfw_drivers_tracking_timing() {
		...
		<label for="lddfw_drivers_tracking_timing">
			<select name='lddfw_drivers_tracking_timing' id='lddfw_drivers_tracking_timing'>
				<option value="" <?php selected( esc_attr( $lddfw_drivers_tracking_timing ), '' ); ?>><?php echo esc_html( __( 'None' ) ); ?></option>
				<option value="60000" <?php selected( esc_attr( $lddfw_drivers_tracking_timing ), '60000' ); ?>><?php echo esc_html( __( 'Every 1 Minute', 'lddfw' ) ); ?></option>
				<option value="120000" <?php selected( esc_attr( $lddfw_drivers_tracking_timing ), '120000' ); ?>><?php echo esc_html( __( 'Every 2 Minutes', 'lddfw' ) ); ?></option>
				<option value="180000" <?php selected( esc_attr( $lddfw_drivers_tracking_timing ), '180000' ); ?>><?php echo esc_html( __( 'Every 3 Minutes', 'lddfw' ) ); ?></option>
				<option value="240000" <?php selected( esc_attr( $lddfw_drivers_tracking_timing ), '240000' ); ?>><?php echo esc_html( __( 'Every 4 Minutes', 'lddfw' ) ); ?></option>
				<option value="300000" <?php selected( esc_attr( $lddfw_drivers_tracking_timing ), '300000' ); ?>><?php echo esc_html( __( 'Every 5 Minutes', 'lddfw' ) ); ?></option>
			</select>
			<p class="lddfw_description" id="lddfw_drivers_tracking_timing-description"><?php echo esc_html( __( 'Set the tracking timing for getting the driver position.', 'lddfw' ) ); ?></p>
		</label>
		<?php
			}
		}
	...
	public function lddfw_driver_commission_type() {
		...
		<select name='lddfw_driver_commission_type' id='lddfw_driver_commission_type'>
			<option value="" <?php selected( esc_attr( $lddfw_driver_commission_type ), '' ); ?>><?php echo esc_html( __( 'Select' ) ); ?></option>
			<option value="fixed" <?php selected( esc_attr( $lddfw_driver_commission_type ), 'fixed' ); ?>><?php echo esc_html( __( 'Fixed Price', 'lddfw' ) ); ?></option>
			<option value="delivery_percentage" <?php selected( esc_attr( $lddfw_driver_commission_type ), 'delivery_percentage' ); ?>><?php echo esc_html( __( 'Delivery total percentage', 'lddfw' ) ); ?></option>
			<option value="order_percentage" <?php selected( esc_attr( $lddfw_driver_commission_type ), 'order_percentage' ); ?>><?php echo esc_html( __( 'Order total percentage', 'lddfw' ) ); ?></option>
			<option value="distance" <?php selected( esc_attr( $lddfw_driver_commission_type ), 'distance' ); ?>><?php echo esc_html( __( 'Distance based pricing - mile / km x price', 'lddfw' ) ); ?></option>
		</select>
		<div id='lddfw_driver_commission_div' style='display:inline-block;'>
		<div id='lddfw_driver_commission_value_wrap' style='display: none;'>
			<span id="lddfw_driver_commission_symbol_currency" style='display:none'><?php echo lddfw_currency_symbol(); ?></span>
			<span id="lddfw_driver_commission_symbol_percentage" style='display:none'>%</span>
			<input type="text" size="5" name="lddfw_driver_commission_value" id="lddfw_driver_commission_value" value="<?php echo $lddfw_driver_commission_value; ?>">
		</div>
		</div>
		</label>
		<?php
	...
	public function lddfw_navigation_app() {
		...
		<select name='lddfw_navigation_app'>
			<option value="wase" <?php selected( esc_attr( $lddfw_navigation_app ), 'wase' ); ?>><?php echo esc_html( __( 'Waze' ) ); ?></option>
			<option value="apple_maps" <?php selected( esc_attr( $lddfw_navigation_app ), 'apple_maps' ); ?>><?php echo esc_html( __( 'Apple Maps' ) ); ?></option>
			<option value="google_maps" <?php selected( esc_attr( $lddfw_navigation_app ), 'google_maps' ); ?>><?php echo esc_html( __( 'Google Maps' ) ); ?></option>
		</select>
		</label>
		<?php
			}
	...
	public function lddfw_driver_info_permission() {
		...
		<p class="description"><?php echo esc_html( __( 'Allow the customer to see the driver information on emails and on his account.', 'lddfw' ) ); ?></p>
		<?php
			}
		}
		echo lddfw_admin_premium_feature( '' );
	...
	public function lddfw_auto_assign_method() {
		...
		<select name='lddfw_auto_assign_method'>
			<option value="1" <?php selected( esc_attr( $lddfw_auto_assign_method ), '1' ); ?>><?php echo esc_html( __( 'Equally according to the number of orders each driver has.', 'lddfw' ) ); ?></option>
			<option value="2" <?php selected( esc_attr( $lddfw_auto_assign_method ), '2' ); ?>><?php echo esc_html( __( 'Unevenly in the following order: zip code, city, state, country, and the number of orders each driver has.', 'lddfw' ) ); ?></option>
		</select>
		</label>
		<?php
		}
	...
	public function lddfw_whatsapp_provider() {
		...
		<p class="description" id="lddfw_sms_provider-description"><?php echo sprintf( esc_html( __( 'For more information about how to create an WhatsApp account %1$sclick here%2$s.', 'lddfw' ) ), '<a href="https://powerfulwp.com/docs/local-delivery-drivers-for-woocommerce-premium/getting-started/whatsapp-settings/" target="_blank">', '</a>' ); ?></p>
		<?php
			}
		}
		echo lddfw_admin_premium_feature( '' );
	...
	public function lddfw_whatsapp_out_for_delivery() {
		...
		<label for="lddfw_whatsapp_out_for_delivery" class='checkbox_toggle'>
			...
			<?php echo esc_html( __( 'WhatsApp to customer when order is out for delivery.', 'lddfw' ) ); ?>
		</label>
		<div class='lddfw_toggle_area' style='display:none'>
			<p style='margin-top:10px;margin-bottom:5px;'><?php echo esc_html( __( 'WhatsApp template', 'lddfw' ) ); ?>
			<?php echo '<a href="#" class="lddfw_copy_template_to_textarea" data="Hello [billing_first_name], status of your order #[order_id] with [store_name] has been changed to [order_status]."><b>' . esc_html( __( 'Default template', 'lddfw' ) ) . '</b></a>'; ?>
...
<label for="lddfw_whatsapp_start_delivery" class='checkbox_toggle'>
	<input <?php echo esc_attr( $checked ); ?> type='checkbox' class='regular-text' name='lddfw_whatsapp_start_delivery' id='lddfw_whatsapp_start_delivery' value='1'>
		<?php echo esc_html( __( 'WhatsApp to customer when the driver started the delivery.', 'lddfw' ) ); ?>
</label>
<div class='lddfw_toggle_area' style='display:none'>
	<p style='margin-top:10px;margin-bottom:5px;'><?php echo esc_html( __( 'WhatsApp template', 'lddfw' ) ); ?>
		<?php echo '<a href="#" class="lddfw_copy_template_to_textarea" data="Hello [billing_first_name], the delivery for order #[order_id] with [store_name] has been started. [estimated_time_of_arrival]"><b>' . esc_html( __( 'Default template', 'lddfw' ) ) . '</b></a>'; ?>
	...
	public function lddfw_whatsapp_start_delivery() {
		...
		<label for="lddfw_whatsapp_start_delivery" class='checkbox_toggle'>
			<input <?php echo esc_attr( $checked ); ?> type='checkbox' class='regular-text' name='lddfw_whatsapp_start_delivery' id='lddfw_whatsapp_start_delivery' value='1'>
			<?php echo esc_html( __( 'WhatsApp to customer when delivery has been started.', 'lddfw' ) ); ?>
		</label>
		<div class='lddfw_toggle_area' style='display:none'>
			<p style='margin-top:10px;margin-bottom:5px;'><?php echo esc_html( __( 'WhatsApp template', 'lddfw' ) ); ?>
			<?php echo '<a href="#" class="lddfw_copy_template_to_textarea" data="Hello [billing_first_name], your order #[order_id] with [store_name] delivery has been started."><b>' . esc_html( __( 'Default template', 'lddfw' ) ) . '</b></a>'; ?>
	...
	public function lddfw_google_api_key() {
		...
		<p>
			<input type='text' class='regular-text' name='lddfw_google_api_key' value='<?php echo esc_attr( get_option( 'lddfw_google_api_key', '' ) ); ?>'><br>
			<span class="description" id="lddfw-gooogle-api-key-description"><?php echo esc_html( __( 'Key for Maps Embed API and Maps JavaScript API, Directions API. ( Application restrictions: HTTP referrers )', 'lddfw' ) ); ?></span>
		</p>
		<p>
			<input type='text' class='regular-text' name='lddfw_google_api_key_server' value='<?php echo esc_attr( get_option( 'lddfw_google_api_key_server', '' ) ); ?>'><br>
			<span class="description" id="lddfw-gooogle-api-key-description"><?php echo esc_html( __( 'Key for Maps Directions API and Distance Matrix API. ( Application restrictions: IP addresses )', 'lddfw' ) ); ?></span>
		</p>
		<?php
	}
