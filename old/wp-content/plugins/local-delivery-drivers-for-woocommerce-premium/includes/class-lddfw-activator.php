...
class LDDFW_Activator {
	...
	public function lddfw_set_options() {
		...
		add_option( 'lddfw_whatsapp_start_delivery_template', 'Hello [billing_first_name], the delivery for order #[order_id] with [store_name] has been started. [estimated_time_of_arrival]' );
