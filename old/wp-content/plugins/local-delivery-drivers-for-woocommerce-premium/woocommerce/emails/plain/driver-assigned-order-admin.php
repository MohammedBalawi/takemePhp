...
echo esc_html__( 'Hello,', 'lddfw' ) . "\n\n";
/* translators: %s: Order number */
echo sprintf( esc_html__( 'Just to let you know &mdash; your order #%s has been claimed by a driver.', 'lddfw' ), esc_html( $order->get_id() ) ) . "\n\n";

$lddfw_driver_id = $order->get_meta('lddfw_driverid');
if ( '' !== $lddfw_driver_id ) {
	$driver = new LDDFW_Driver();
	if ( '' !== $lddfw_driver_id ) {
		echo $driver->get_driver_info__premium_only( $lddfw_driver_id, 'text', true );
