...
echo sprintf( esc_html__( 'Just to let you know &mdash; the delivery for your order #%s has been started.', 'lddfw' ), esc_html( $order->get_id() ) ) . "\n\n";
...
if ( ! empty ( $route ) ) {
	...
	if ( '' !== $duration_text ) {
		echo sprintf( esc_html__( 'Estimated time of arrival: %s', 'lddfw' ), esc_html( $duration_text ) ) . "\n\n";
	}
}
