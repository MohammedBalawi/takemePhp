...
echo sprintf( esc_html__( 'Just to let you know &mdash; your order #%s delivery has failed:', 'lddfw' ), esc_html( $order->get_id() ) ) . "\n\n";
...
$lddfw_order_signature = $order->get_meta('lddfw_order_last_signature');
	...
	echo '<a href="' . esc_attr( $lddfw_order_signature ) . '" target="_blank">' . $lddfw_order_signature . '</a>';
}
...
if ( '' !== $lddfw_order_delivery_image ) {
	...
	echo '<a href="' . esc_attr(  $lddfw_order_delivery_image ) . '" target="_blank">' . $lddfw_order_delivery_image . '</a>';
}
