...
export default function SearchScreen(props) {
  ...
  return (
    <View style={styles.mainView}>
      <View style={{ height: '85%', backgroundColor: MAIN_COLOR }}>
        <View style={{ height: '100%', backgroundColor: colors.WHITE, borderBottomRightRadius: 120 }}>
          <View>
            ...
            <FlatList
              ...
              renderItem={({ item, index }) => {
                return (
                  <View key={"key" + index} style={{ flexDirection: 'row', width: '100%'}}>
